	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			...
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">Blood donation is a voluntary process where individuals donate their blood for medical purposes. It is an important and lifesaving contribution to healthcare systems.</p>
			</div>
			<div class="d-flex">
