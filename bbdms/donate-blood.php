...
<body>
	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Blood Donor</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
 ...
 <div class="login px-4 mx-auto mw-100">
                            <h5 class="text-center mb-4">Donate Blood</h5>
...
<?php }} ?>
                                ...
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" class="form-control" name="address" id="address" required="true" placeholder="Address" required>
                                </div>
                                <div class="form-group">
                                    <label>Message</label>
                                ...
                                <div class="form-group">
                                    <label>Any Disease(mention NA if not applicable)</label>
                                    <input type="text" class="form-control" name="mention" id="password" required="">
                                </div>
                               
                                <button type="submit" class="btn btn-primary submit mb-4" name="submit">Submit</button>
                            </form>
                        </div>
