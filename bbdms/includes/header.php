...
<div id="home">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item mx-lg-4 my-lg-0 my-3">
                            <a class="nav-link" href="viewcampaign.php">Campaigns</a>
                        </li>
                        <li class="nav-item mx-lg-4 my-lg-0 my-3">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="request-received.php">Requests Received</a>
            <a class="dropdown-item" href="request-sent.php">Requests sent</a>
...
<?php } ?>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-select@1.7.2/dist/css/bootstrap-select.min.css">

    <!-- Include Bootstrap-select JavaScript -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.7.2/dist/js/bootstrap-select.min.js"></script>
