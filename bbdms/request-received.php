						...
						<tbody>
							...
							?>
									<tr>
										...
										<td>
											<a href="approve-request.php?id=<?php echo $row->donid; ?>" onclick="return confirm('Are you sure you want to approve this blood request?')" class="btn btn-success">Approve</a>
											<a href="reject-request.php?id=<?php echo $row->donid; ?>" onclick="return confirm('Are you sure you want to reject this blood request?')" class="btn btn-danger">Reject</a>
										</td>
									</tr>
								<?php
									$cnt = $cnt + 1;
