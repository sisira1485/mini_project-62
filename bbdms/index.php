						...
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>One Blood Donation Save three Lives
									<span>every day</span></h3>
									<h1 style="font-weight:bold; color:red">Sometimes money cannot save life
                ...
                <div class="col-md-4 pricing" style="margin-top:2%;">
                    ...
                    <div class="price-bottom p-4">
                        ...
                        if (isset($_SESSION['bbdmsdid'])) {
                            // User is logged in, show the "Request" button
                            echo '<a class="btn btn-primary" style="color:#fff" href="contact-blood.php?cid='.$result->id.'">Request</a>';
                        }  else {
							// User is not logged in, show an alert message
							echo '<button class="btn btn-primary" style="color:#fff" onclick="showAlert()">Request</button>';
						}
                        ?>
...
if (isset($_SESSION['bbdmsdid'])) {
    // User is logged in, show the "Request" button
    echo '<a class="btn btn-primary" style="color:#fff" href="donate-blood.php?cid='.$result->id.'">Become a Donor</a>';
} else {
    // User is not logged in, show an alert message
    echo '<button class="btn btn-primary" style="color:#fff" onclick="showt()">Become a Donar</button>';
}
?>
